...
if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/dwdsdownload.png", dpi = 400)
} else {
  knitr::include_graphics("docs/fig/dwdsdownload.gif")
}
...
knitr::include_graphics("docs/fig/conc_in_editor.png", dpi = 450)
```
...
knitr::include_graphics("docs/fig/conc_in_excel_bad.png", dpi = 500)
```
...
if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/import_in_excel.png", dpi = 450)
} else {
  knitr::include_graphics("docs/fig/import_in_excel.gif")
}
...
knitr::include_graphics("docs/fig/calc_import.png")
```
