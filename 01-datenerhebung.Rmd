...
if (knitr:::is_latex_output()) {
  knitr::include_graphics("fig/dwdsdownload.png")
} else {
  knitr::include_graphics("figs/dwdsdownload.gif")
}
...
knitr::include_graphics("fig/conc_in_editor.png")
```
...
knitr::include_graphics("fig/conc_in_excel_bad.png")
```
...
3. Öffnen Sie ein leeres Tabellenblatt in Excel. Die nächsten Schritte, 4 bis , sind in \@ref(fig:importexcel) visualisiert.
...
if (knitr:::is_latex_output()) {
  knitr::include_graphics("fig/import_in_excel.png")
} else {
...
```{r calcimport, echo = FALSE, out.width = '60%', out.height = '60%', fig.cap="Import in Calc"}
