...
ich wieder Wege für Excel und Calc. Gerade die unten skizzierte
...
\paragraph{Umsetzung in Excel}\label{umsetzung-in-excel}
...
\begin{figure}
\includegraphics[width=6.66in]{fig/excel_bulk_change} \caption{Eine Tabellenspalte wird so gefiltert, dass nur noch die leeren Zellen zu sehen sind, und allen leeren Zellen wird derselbe Wert zugewiesen.}\label{fig:excelbulkchange}
\end{figure}
