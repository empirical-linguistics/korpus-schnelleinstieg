...
knitr::include_graphics("fig/praedikativ_filter.png", dpi = 400)
...
knitr::include_graphics("fig/excel_allfilters.png", dpi = 400)
...
if (knitr:::is_latex_output()) {
  knitr::include_graphics("fig/excel_visualize.png", dpi = 450)
} else {
  knitr::include_graphics("fig/excel_visualize.gif")
}
