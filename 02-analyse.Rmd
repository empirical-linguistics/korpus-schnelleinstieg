...
if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/excelastable01.png", dpi = 450)
} else {
  knitr::include_graphics("docs/fig/excelastable01.gif")
}
...
```{r excelwrap, echo = FALSE, fig.cap="Zeilenumbruch innerhalb von Zellen einschalten"}

if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/excellinewrap.png", dpi = 450)
} else {
  knitr::include_graphics("docs/fig/excellinewrap.gif")
}
...
```{r excelbulkchange, echo = FALSE, fig.cap="Eine Tabellenspalte wird so gefiltert, dass nur noch die leeren Zellen zu sehen sind, und allen leeren Zellen wird mit Strg/Cmd+Enter derselbe Wert zugewiesen."}

if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/excel_bulk_change.png", dpi = 450)
} else {
  knitr::include_graphics("docs/fig/excel_bulk_change.gif")
}
...
```{r calcformat, echo = FALSE, fig.cap="Formatierung der Tabelle in Calc und Setzen eines Filters"}

if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/calcformat.png", dpi = 450)
} else {
  knitr::include_graphics("docs/fig/calcformat.gif")
}
...
```{r calcbulkchange, echo = FALSE, fig.cap="Eine Tabellenspalte wird so gefiltert, dass nur noch die leeren Zellen zu sehen sind, und allen leeren Zellen wird mit Alt+Enter derselbe Wert zugewiesen."}

if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/calc_bulkchange.png", dpi = 450)
} else {
  knitr::include_graphics("docs/fig/calc_bulkchange.gif")
}
...
```{r excelpivot, echo = FALSE, fig.cap="Erstellen einer Pivot-Tabelle in Excel."}

if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/excelpivot.png", dpi = 450)
} else {
  knitr::include_graphics("docs/fig/excel_pivot.gif")
}
...
```{r excelpivotsimple, echo = FALSE, fig.cap="Eine Pivot-Tabelle in Excel."}

knitr::include_graphics("docs/fig/excel_simplepivot.png", dpi = 300)
...
```{r countofhit, echo = FALSE, fig.cap="Entfernen einer Spalte aus dem \"Werte\"-Feld."}

knitr::include_graphics("docs/fig/countofhit.png", dpi = 400)
...
```{r praedikativfilter, echo = FALSE, fig.cap="Herausfiltern der Daten mit \"praedikativ=n\"."}

knitr::include_graphics("docs/fig/praedikativ_filter.png", dpi = 400)
...
```{r excelfilter, echo = FALSE, fig.cap="Tabellarische Auswertung der Korpusdaten mit Hilfe der PivotTable-Funktion."}

knitr::include_graphics("docs/fig/excel_allfilters.png", dpi = 400)
...
```{r excelvisualize, echo = FALSE, fig.cap="Erstellen eines Balkendiagramms aus einer Pivot-Tabelle in Excel."}

if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/excel_visualize.png", dpi = 450)
} else {
  knitr::include_graphics("docs/fig/excel_visualize.gif")
}
...
```{r pivotchartfields, echo = FALSE, fig.cap="Der Dialog \"Pivot Chart Fields\" (rechts) erlaubt es, anzupassen, was wo in der Grafik dargestellt wird."}

knitr::include_graphics("docs/fig/excel_pivotchartfields.png", dpi=400)
...
```{r asymmetric, echo = FALSE, fig.cap="Balkendiagramm, in dem nicht belegte Variablenausprägungen ausgelassen werden."}


knitr::include_graphics("docs/fig/excel_asymmetric.png", dpi = 450)
...
```{r calcpivot, echo = FALSE, fig.cap="Erstellen einer Pivot-Tabelle in Calc."}

if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/calc_pivot.png", dpi = 450)
} else {
  knitr::include_graphics("docs/fig/calc_pivot.gif")
}
...
```{r calcchart, echo = FALSE, fig.cap="Erstellen einer Pivot-Tabelle in Calc."}

if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/calc_chart.png", dpi = 450)
} else {
  knitr::include_graphics("docs/fig/calc_chart.gif")
}
...
```{r calcchart2, echo = FALSE, fig.cap="Erstellen einer Pivot-Tabelle mit Nullwerten in Calc (Workaround)."}

if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/calc_chart2.png", dpi = 450)
} else {
  knitr::include_graphics("docs/fig/calc_chart2.gif")
}
...
```{r calcdatalabels, echo = FALSE, fig.cap="Einfügen von Data labels in Calc."}

if (knitr:::is_latex_output()) {
  knitr::include_graphics("docs/fig/calc_datalabels.png", dpi = 450)
} else {
  knitr::include_graphics("docs/fig/calc_datalabels.gif")
}
