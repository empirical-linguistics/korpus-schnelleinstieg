...
```{r excelpivotsimple, echo = FALSE, fig.cap="Erstellen einer Pivot-Tabelle in Excel."}

knitr::include_graphics("docs/fig/excel_simplepivot.png", dpi = 400)
...
```{r praedikativfilter, echo = FALSE, fig.cap="Entfernen einer Spalte aus dem \"Werte\"-Feld."}
...
```{r calcchart2, echo = FALSE, fig.cap="Erstellen einer Pivot-Tabelle in Calc."}
